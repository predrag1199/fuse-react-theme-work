    ...
    render()
    {
        ...
        return (
            <div className={classNames(classes.root, "flex flex-1 items-center justify-between p-8 sm:p-24")}>
                ...
                <div className="flex flex-shrink items-center sm:w-330">
                    <div className="flex items-center">
                        <FuseAnimate animation="transition.expandIn" delay={300}>
                            <Icon className="text-32 mr-12">account_box</Icon>
                        </FuseAnimate>
                        <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                            <Typography variant="h6" className="hidden sm:flex">Yebo!World User Admin</Typography>
                        </FuseAnimate>
                    </div>
                </div>
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        getContats: Actions.getContacts,
